...
public class RESTServicesConsumer {
	...
	static final String USERNAME = "khemanshurao@metacube.com";
	static final String PASSWORD = "sales16181389X4OlCmrVFNKXruYtHhglggd9";
	static final String LOGINURL = "https://login.salesforce.com";
	static final String GRANTSERVICE = "/services/oauth2/token?grant_type=password";
	static final String CLIENTID = "3MVG9ZL0ppGP5UrBPk.ErL1p0CupiZV01mgLsn1mvgdiX9WDw64NoKfFwr6ncnDeaxvW59Gsk6oXUIhxuaVN8";
	static final String CLIENTSECRET = "3480638622261229905";
	...
	public static void queryContacts() {
		...
		try {
			...
			String uri = baseUri
					+ "/query?q=SELECT+Id+,+Name,+Experience__c,+Languages__c,+Level__c,+Birthdate,+Subjects__c+FROM+Contact";
	...
	public static void createStudents() {
		...
		try {
			...
			student.put("LastName__c", "Wilson");
			student.put("Class__c", "a0828000008lGSv");
