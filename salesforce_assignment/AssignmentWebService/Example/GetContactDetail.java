...
public class GetContactDetail {
	...
	private final static String CONTACTID = "0032800000CNwu2";
	private final static String CONTACTNAME = "Nitin Agrawal";
	private final static String CONTACTEMAIL = "khemanshu.rao@metacube.com";
	private final static String LOGINID = "khemanshurao@metacube.com";
	private final static String PASSWORD = "sales16181389X4OlCmrVFNKXruYtHhglggd9";
