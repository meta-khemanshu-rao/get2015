...
public class InsertStudent {
	private final static String CLASSID = "a0828000008lGSv";
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Insert Student in Existing class.  Id Of Student is  \n"
					+ stub.createStudentWithClassid(NAME, LASTNAME, CLASSID));
			
			System.out.println("Id of Recently Created Student is -- \n"
					+ stub.createStudentWithRequiredField(NAME, LASTNAME, CLASSNAME));
		}
		catch (Exception e) {
